export default function DashboardContent() {
  return (
    <div className='absolute top-[308px] left-[377px] w-[968px] h-[812px] bg-white rounded-[30px] shadow-[0px_10px_60px_rgba(226,_236,_249,_1)] overflow-x-auto px-6 pt-6'>
